...
namespace APP.NormalStudent
{
    public partial class OrderByClass : MetroFramework.Forms.MetroForm
    {
        ...
        private void metroCombo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            NumberEx.Text = "Số học sinh trung bình: " + metroGrid.RowCount + " học sinh. (" + Math.Round((double)metroGrid.RowCount / (double)Class_BUL.LoadBySC(SchoolYearID)[metroCombo.SelectedIndex].Students, 2, MidpointRounding.AwayFromZero) * 100 + "%).";
